# AI Context & Instructions for home-assistant-prismatik

## 🧬 Project DNA
**Repository:** `home-assistant-prismatik`
**Type:** Home Assistant Custom Integration
**Domain:** `prismatik`
**Description:** A modern Home Assistant integration to control **Prismatik** (and compatible clones like Lightpack). Control your ambient lighting, adjust gamma, smoothness, and toggle various modes directly from Home Assistant.
...
### 🚀 Google Antigravity
- **Codebase Navigation:** Begin by analyzing `custom_components/prismatik/`. Search for established patterns in `api.py` or `coordinator.py` before modifying entities.
